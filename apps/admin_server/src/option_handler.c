...
static int process_n_option(char * optarg, options_t * options_p)
{
    ...
    {
        print_error("process_n_option(): NULL argument passed.");
        goto END;
    }
    ...
    {
        print_error("process_n_option(): '-n' flag already true.");
        goto END;
    }
    else
    {
    ...
    {
        print_error("process_n_option(): Number of threads must be 2 or more.");
